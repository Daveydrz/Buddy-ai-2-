...
def audio_playback_worker():
    ...
    while True:
        ...
        try:
            ...
            # ✅ Mark start of actual speech + begin full-duplex VAD
            buddy_talking.set()
            start_background_vad_thread()
            ...
            buddy_talking.clear()  # ✅ Mark end of TTS so VAD stops
...
def generate_and_play_kokoro(text, lang=None):
    ...
    try:
        ...
        print(f"[DEBUG][TTS] First 10 samples: {samples[:10] if hasattr(samples, '__getitem__') else 'N/A'}")
