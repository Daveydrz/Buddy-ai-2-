...
def audio_playback_worker():
    ...
    SPEAKER_DEVICE_INDEX = 12  # Set this to your actual output device index
    ...
    while True:
        try:
            ...
            print(f"[Buddy][Playback] audio_np shape: {audio_np.shape}, dtype: {audio_np.dtype}, max: {np.max(audio_np)}, min: {np.min(audio_np)}")
